# Coclé cerámica
Este es un proyecto de ecommerce básico desarrollado para el curso de React. La aplicación simula una tienda virtual, donde se detalla una serie de productos de ceramica y permite realizar una compra en línea. Los productos y las órdenes de compra se almacenan en Firebase.
...
- Eliminar productos del carrito de comras
